...
async function robot(){
    ...
    async function uploadVideo(content){
        ...
        const videoFileSize = fileSystem.statSync(videoFilePath).size
        ...
        const requestParameters = {
            ...
            media: {
                body: fileSystem.createReadStream(videoFilePath)
            }
        }
    ...
    async function uploadThumbnail(videoInformation){
        ...
        const requestParameters = {
            ...
            media: {
                mimeType: 'image/jpeg',
                body: fileSystem.createReadStream(videoThumbnailFilePath)
            }
        }
